...
This is a pre-release version, only tested in simulator.
...
After installation, the new tool is available in your System menu. If you flash the tool icon, it will link to the github repository.
